...
public class XuaHoaDonView extends JDialog {
   ...
   // private DlgTimMaGiam timMaUI;
    ...
    public XuaHoaDonView(ArrayList<Vector> dsGioHang, int tongTien) {
        this();
...
/*        txtMaGiam.getDocument().addDocumentListener(new DocumentListener() {
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        hoadonBUS.luuHoaDon(DlgTimKhach.khachHangTimDuoc.getMaKH(), tongTien, "Đã thanh toán");
