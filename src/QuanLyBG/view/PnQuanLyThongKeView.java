...
import QuanLyBG.controller.ThongKeController;
...
public class PnQuanLyThongKeView extends JPanel {

    public PnQuanLyThongKeView() {
        changLNF("Windows");
        addControls();
        addEvents();
    }

    ThongKeController thongKeBUS = new ThongKeController();
    final Color colorPanel = new Color(0, 0, 0);


    JLabel lblThongKeDoanhThu;
    ...
    private void addControls() {
        ...
        JLabel lblTileThongKeTong, lblBackgroundDoanhThu;
       ...
       // lblBackgroundNhanVien.setBounds(98, 340, 369, 201);98, 350, 232, 87
         lblBackgroundDoanhThu.setBounds(300, 125, 369, 200);//350, 220, 280, 100
     ...
     //   lblThongKeThucDon.setBounds(98, 100, 232, 87);
      ...
      //  lblThongKeNhanVien.setBounds(98, 350, 232, 87);
        lblThongKeDoanhThu.setBounds(350, 120, 280, 100);
     ...
     //   pnThongKeTong.add(lblBackgroundKhachHang);
       // pnThongKeTong.add(lblBackgroundNhanVien);
        ...
        cmbNam.setBounds(100, 350, 120, 35);
...
//        pnThongKeTong.add(btn_filter);
        ...
        lblBackgroundBang.setBounds(98, 415, 834, 189);
